    ...
    <script>
        function cart() {
            ...
            for ($i = 0; $i < count(get_all_cartAdmin()); $i++) {
                    ...
                    cellCus.innerHTML = "<?php echo get_all_Use()[get_all_cartAdmin()[$i][3]-1][3] ?>";
                    cellAddress.innerHTML = "<?php echo get_all_Use()[get_all_cartAdmin()[$i][3]-1][4] ?>";   

                    cellimg.innerHTML ='<div><img src="<?php echo get_all_product()[get_all_cartAdmin()[$i][1]][5] ?>" id="img" style="width:50px;height:50px"></div>';
                    cellname.innerHTML = "<?php echo get_all_product()[get_all_cartAdmin()[$i][1]][3] ?>";
                    cellquantity.innerHTML = '<?php echo get_all_cartAdmin()[$i][2] ?>';
                    cellprice.innerHTML = '<?php echo get_all_product()[get_all_cartAdmin()[$i][1]][2] ?>';
