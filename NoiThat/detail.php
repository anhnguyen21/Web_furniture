        ...
        <section class="detail1">
            <div class="container">
                <div class="imgDetail" style="width:40%">
                    <img src="<?php echo get_all_product()[ $_SESSION['index']-1][5] ?>" alt="" style="width: 400px;height: 300px;">
                </div>
                <div class="detail">
                    <p class="detail_text">
                        <?php echo get_all_product()[ $_SESSION['index']-1][1] ?>
                    </p>
                    <h3 style="color:red;"><?php echo get_all_product()[$_SESSION['index']-1][2] ?>đ</h3>
                    Dòng sản phẩm: <?php echo get_all_product()[$_SESSION['index']-1][3] ?></span>
                    <h2>MÔ TẢ:</h2>
                    <span style="opacity: 0.8;"><?php echo get_all_product()[$_SESSION['index']-1][4] ?></span>
                    ...
                    <button type="button" class="btn btn-success" style="margin: 0 0 0 30px;">Mua ngay</button>
                    </div>

                    <a class="iWishAdd">
                        <span class="iwishAddChild iwishAddBorder"><img class="iWishImg" style="width:30px;height:30px;color:red;" src="http://wishlists.sapoapps.vn/content/images/iwish_add.png" alt="Megashop"></span>
