    ...
    <script>
        function cart() {
            ...
            for ($i = 0; $i < count(getCustomer()); $i++) {
                    ...
                    cellCus.innerHTML = "<?php echo get_all_Use()[getCustomer()[$i][3]-1][3] ?>";
                    cellAddress.innerHTML = "<?php echo get_all_Use()[getCustomer()[$i][3]-1][4] ?>";   
                    cellPhone.innerHTML = "<?php echo get_all_Use()[getCustomer()[$i][3]-1][5] ?>";
