                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php echo total() ?>d</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row">Thanh toán</th>
                                <td><?php echo total() ?>d</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-dialog" role="document" >
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6" style="padding: 0 0 0 20px;">
                        ...
                        <em><?php echo get_all_Use()[idUser()-1][3] ?></em><br>
                        <em><?php echo get_all_Use()[idUser()-1][5] ?></em><br>
                    </div>
                </div>
                <div class="row">
                    ...
                    <table class="table table-hover text-center" id="pay" style="font-size: 12px;">
                        ...
                        <p class="text-center text-danger" style="padding:0 0 0 220px"> <h4><strong>Total: </strong></h4><h4><strong><?php echo total() ?>d</strong></h4></p>
    ...
    <script>
        function pay() {
            ...
            for ($i = 0; $i < count(get_all_Cart()); $i++) {
                    ...
                    // celldelete.innerHTML ='<form action="" method="post"><button onload="cart()" name="delete" value= class="btn btn-danger">Xoa</button></form>'; 
