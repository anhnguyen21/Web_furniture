<?php
    ...
    if(isset($_POST['add'])){
        $name=$_POST['npd'];
        $price=$_POST['ppd'];
        if(isset($_POST['typro'])){
            $typePro=$_POST['typro'];
            if (isset($_POST['add'])) {
                $image=getUploadFile($typePro);
                echo 1;
            }
        }
        $type=$_POST['type'];
        ...
        addProductAdimn($name,$price,$type,$typePro,$detail,$image,$quan,$dat);
    }
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-table"></i> Product</div>
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="add">
                                <form action="" method="POST"  class="form-inline" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="namepd">Quantity</label>
                                        <input type="text" name="quan" id="quan" class="form-control col-md-4 ">
                                        <label for="codepd">Date</label>
                                        <input type="date" name="dateOder" data-date-format="mm/dd/yyyy">
                                    </div>
                                    <div class="form-group col-md-12">
