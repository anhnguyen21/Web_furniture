        ...
        function cart() {
            ...
            for ($i = 0; $i < count(get_all_product()); $i++) {
                    ?>
                        ...
                        var celltdateinput = row.insertCell();
                        var celldelete = row.insertCell();
                        cellimg.innerHTML ='<div><img src="<?php echo get_all_product()[$i][5] ?>" id="img" style="width:100px;height:100px"></div>';
                        cellname.innerHTML = "<?php echo get_all_product()[$i][3] ?>";
                        celltype.innerHTML = "<?php echo get_all_product()[$i][6] ?>";
                        cellquantity.innerHTML = "<?php echo get_all_product()[$i][7] ?>";
                        cellprice.innerHTML = '<?php echo get_all_product()[$i][2] ?>';
                        celltdateinput.innerHTML='<?php echo get_all_product()[$i][8] ?>';
                        celldelete.innerHTML ='<form action="" method="post"><button onload="cart()" name="delete" value=<?php echo get_all_product()[$i][0] ?> class="btn btn-danger">Xoa</button></form>'; 
                    <?php
            } ?>
        }
    </script>
        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item" href="register.html">Add customer:</a>
                </div>
            </li>
            <li class="nav-item active">
                ...
                <div class="bg-white dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item" href="login.html">Selling products</a>
